...
var ParticleEngine = (function() {
    ...
    function range(min, max, decimalplaces)
    {
    ...
    function weightedRange(min, max, decimalplaces, weights, weightFactor)
    {
        var rand = Math.random();
        var weight = rand < weightFactor ? weights[0] : weights[1];
        var rand = min + Math.random() * (max - min);
        var power = Math.pow(10, decimalplaces || 0);
        return Math.floor(rand * power) / power;
    }
...
var pe = new ParticleEngine("projector");
pe.render();
